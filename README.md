...
# 🎮 Pokémon Dataset Generator v3.4
...
[**📖 Full Documentation**](docs/README.md) • [**🚀 Feature List**](docs/FEATURES.md) • [**📜 Changelog**](docs/CHANGELOG.md)
...
| ⚙️ **Dataset Generation** | <ul><li>Automatic card image downloader (TCGdex API)</li><li>25 augmentation techniques via `Albumentations` (NumPy 2.x compatible)</li><li>5+ realistic holographic effects (rainbow, metallic, etc.)</li><li>Annotated mosaic generation for robust training</li><li>Automatic class balancing to prevent dataset bias</li></ul> |
...
| 🛠️ **Project & Maintenance** | <ul><li>Centralized script catalog (`scripts/SCRIPTS_REFERENCE.py`)</li><li>Isolated `.venv` environment for clean dependency management</li><li>Project integrity tests to validate structure and dependencies</li><li>Comprehensive documentation for every feature</li></ul> |
...
| Guide | Description |
| :--- | :--- |
| 📖 **[Documentation Hub](docs/README.md)** | Entry point to all documentation, organized by use case. |
| 👤 **[User Guide](docs/USER_GUIDE.md)** | Complete user guide, from installation to detection. |
| 📥 **[Installation](docs/INSTALLATION.md)** | Detailed installation and troubleshooting. |
| ❓ **[FAQ](docs/FAQ.md)** | 60 questions & answers across 10 categories. |
...
| 💻 **[Technical Guide](docs/TECHNICAL_GUIDE.md)** | Architecture and module documentation for developers. |
